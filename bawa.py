...
def load_data():
    with st.spinner(text="Loading and indexing the Bain Report docs – hang tight! This should take 1-2 minutes."):
        ...
        service_context = ServiceContext.from_defaults(llm=OpenAI(model="gpt-3.5-turbo", temperature=0.5, system_prompt="You are an expert on the Bain Reports and your job is to answer technical questions. Assume that all questions are related to the Bain Reports. Keep your answers technical and based on facts – do not hallucinate features."))
